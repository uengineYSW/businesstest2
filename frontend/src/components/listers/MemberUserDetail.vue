<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="Amoutpayment" v-model="item.amoutpayment" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Membergrade" v-model="item.membergrade" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
